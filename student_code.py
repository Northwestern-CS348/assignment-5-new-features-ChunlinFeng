...
def buildFeatureStatement(tree):
 ...
 ##### Your code to extractRoot here
    ...
    #ExistentialTarget = languageTools.extractExistentialTarget(tree);
    #Target = languageTools.extractTarget(tree);
    #DirectObject = languageTools.extractObject(tree);
    #Preps = languageTools.extractPreps(tree);
    #PrepsAll = languageTools.extractPrepsAll(tree);
    #ObjectFromPrep = languageTools.extractObjectFromPrep(tree);
...
##### Your code to extractSubject here
    ...
    # words in the text.  They will always be names of existing objects. You need the names for the
    # other functions

##### Your code to resolveObjectFOPC here -- this will build some FOPC and Assert it
    Object_Subject = core.resolveObjectFOPC(Subject)
...
##### Your code to findAndAssertFeaturesFOPC here -- this takes the root and your names
    Features = core.findAndAssertFeaturesFOPC(Root, Object_Subject)

##### Your code to findAndAssertDefinitionsFOPC -- this takes the root and your names
    Definitions = core.findAndAssertDefinitionsFOPC(Root, Object_Subject)